...
<meta name="description" content="Samuel Müller Portfolio">
<meta name="author" content="Marketify">
<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1">

<meta content="cracky.eu - Who am I" property="og:title" />
<meta content="Find out who am I..." property="og:description" />
<meta content="https://cracky.eu" property="og:url" />
<meta content="https://cracky.eu/img/og/static.png" property="og:image" />
<meta content="#9a40bf" data-react-helmet="true" name="theme-color" />

<link rel="apple-touch-icon" sizes="180x180" href="/favicon/apple-touch-icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="favicon/favicon-16x16.png">
    <link rel="manifest" href="/site.webmanifest">
    <link rel="mask-icon" href="favicon/safari-pinned-tab.svg" color="#b45bd5">
...
<!-- WRAPPER ALL -->
<div class="arlo_tm_all_wrap" data-magic-cursor="" data-color="purple">
	...
	<div class="arlo_tm_hero" id="home">
		...
		<div class="content">
			<div class="image_wrap">
				<div class="main" data-img-url="https://cracky.eu/img/profile/image.png"></div>
			</div>
			<div class="name_holder">
				<h3>0815 <span>Cracky</span></h3>
			</div>
			...
			<div class="about_inner">
				<div class="left">
					<div class="about_image_wrap parallax" data-relative-input="true">
						<div class="image layer" data-depth="0.1">
							<img src="https://cdn.cracky.eu/img/ratios/550x650.jpg" alt="" />
				...
				<div class="right">
					<div class="about_title">
						<h3>I'm Cracky and <span class="arlo_tm_animation_text_word"></span></h3>
					</div>
					<div class="text">
						<p>Hi! My name is <span>0815Cracky</span>. I am a Web Hoster and Gamer, I'm very passionate and dedicated to my work. I run all Websites and Services on my own, I use OpenSource Projects for many parts, like Nextcloud, Pterodactyl or many other applications.</p>
					</div>
					<div class="about_short_contact_wrap">
						<ul>
							<li>
								<img class="svg" src="img/svg/gift.svg" alt="" />
								<span><label>Birthday:</label> 09.11.2004</span>
							</li>
							<li>
							...
							<li>
								...
								<span><label>Location:</label> <a class="href_location" href="https://goo.gl/maps/QWGHGhkWdW26DfQt7">Hauzenberg, Germany</a></span>
							</li>
							<li>
								<img class="svg" src="img/svg/game-controller-2.svg" alt="" />
								<span><label>Interests:</label> Gaming, Developing</span>
							</li>
							<!-- <li>
							...
							<li>
								...
								<span><label>Mail:</label> <a href="mailto:cracky@myra.nz">info&#64;cracky.eu</a></span>
							</li>
							<!-- <li>
					...
					<!-- <div class="arlo_tm_button">
						<a href="https://cdn.cracky.eu/img/resume/Cracky.vcf" download><span>Download vCard </span></a>
					</div> -->
				</div>
			</div>
		</div>
					...
					<ul>
						<li class="wow fadeInLeft" data-wow-duration="1.5s">
							<div class="inner">
								...
								<p>It's a lot of fun, you have the nearly unlimited power to do what ever you want, like Gameserver...</p>
							</div>
						</li>
						<li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.2s">
							<div class="inner">
								...
								<h3>Web Hosting</h3>
								<p>Web hosting is the backbone of the internet without it, it would be boring... </p>
							</div>
						</li>
						<li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.4s">
							<div class="inner">
								...
								<h3>My Message</h3>
								<p>Do what ever you want to do (aslong it's legal) we all have limited time on earth, be creative!</p>
							</div>
						</li>
						<!-- <li class="wow fadeInLeft" data-wow-duration="1.5s">
							<div class="inner">
						...
						<li class="wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay="0.4s">
							<div class="inner">
								...
								<h3>Social Media</h3>
								<p>Don't follow me on Instagram or anything there is nothing important^^</p>
							</div>
						</li>
					</ul>
					<div class="lets_work wow fadeInLeft" data-wow-duration="1.5s">
						<p>Are you interested in working with me? <a href="#contact"> Let's get started now!</a></p>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="portfolio_inner">
					...
					<div class="portfolio_list">
						<ul class="gallery_zoom">
							<li class="projects">
								<div class="inner">
									<div class="entry arlo_tm_portfolio_animation_wrap" data-title="DRKZ.eu" data-category="Projects">
										<a class="zoom" href="https://image.crcy.de/i/DRKZ-logo-1-1on1200px.png">
											<img src="https://image.crcy.de/i/DRKZ-logo-1-1on1200px.png" alt="" />
											<div class="main_image" data-img-url="https://image.crcy.de/i/DRKZ-logo-1-1on1200px.png"></div>
										</a>
									</div>
								</div>
							</li>
							<li class="projects">
								<div class="inner">
									<div class="entry arlo_tm_portfolio_animation_wrap" data-title="myra.nz" data-category="Projects">
										<a class="zoom" href="https://image.crcy.de/i/myranz-shadow-1-1.png">
											<img src="https://image.crcy.de/i/myranz-shadow-1-1.png" alt="" />
											<div class="main_image" data-img-url="https://image.crcy.de/i/myranz-shadow-1-1.png"></div>
										</a>
									</div>
								</div>
							</li>
							<!-- <li class="design">
								<div class="inner">
									<div class="entry arlo_tm_portfolio_animation_wrap" data-title="ConfigHub" data-category="Design">
							...
							<li class="design">
								<div class="inner">
									<div class="entry arlo_tm_portfolio_animation_wrap" data-title="ConfigHub" data-category="Design">
										<a class="zoom" href="https:///image.crcy.de/file/ConfigHub-Version-2_3.gif">
											<img src="https:///image.crcy.de/file/ConfigHub-Version-2_3.gif" alt="" />
											<div class="main_image" data-img-url="https://image.crcy.de/file/ConfigHub-Version-2_3.gif"></div>
										</a>
									</div>
								</div>
							</li>
							<!-- <li class="photography">
								<div class="inner">
									<div class="entry arlo_tm_portfolio_animation_wrap" data-title="Black Coffee" data-category="Photography">
										<a class="zoom" href="https://cdn.cracky.eu/img/portfolio/4.jpg">
											<img src="https://cdn.cracky.eu/img/ratios/ratio-1-1.jpg" alt="" />
											<div class="main_image" data-img-url="https://cdn.cracky.eu/img/portfolio/4.jpg"></div>
										</a>
									</div>
								</div>
							</li>
							<li class="branding">
								<div class="inner">
									<div class="entry arlo_tm_portfolio_animation_wrap" data-title="Blue Lemon" data-category="Branding">
										<a class="popup-youtube" href="https://www.youtube.com/watch?v=ICr_bOuM9Zo">
											<img src="https://cdn.cracky.eu/img/ratios/ratio-1-1.jpg" alt="" />
											<div class="main_image" data-img-url="https://cdn.cracky.eu/img/portfolio/5.jpg"></div>
										</a>
									</div>
								</div>
							</li>
							<li class="design">
								<div class="inner">
									<div class="entry arlo_tm_portfolio_animation_wrap" data-title="Sweet Cherry" data-category="Photography">
										<a class="zoom" href="https://cdn.cracky.eu/img/portfolio/6.jpg">
											<img src="https://cdn.cracky.eu/img/ratios/ratio-1-1.jpg" alt="" />
											<div class="main_image" data-img-url="https://cdn.cracky.eu/img/portfolio/6.jpg"></div>
										</a>
									</div>
								</div>
							</li> -->
		...
		<div class="arlo_tm_counter_section">
			<div class="container">
				<div class="counter_inner">
					<ul class="wow fadeInLeft" data-wow-duration="4s">
						<li>
							<div class="list_inner">
								<h3 class="arlo_tm_counter" data-from="0" data-to="4" data-speed="2000">0</h3>
						...
						<li>
							<div class="list_inner" id="countup1">
								<!-- <h3 class="arlo_tm_counter" data-from="0" data-to="6574" data-speed="2000">0</h3>  -->
								<h3 class="timeel days">00</h3>
								<span>Days On Earth</span>
							</div>
						</li>
						<li>
							<div class="list_inner">
								<h3 class="arlo_tm_counter" data-from="0" data-to="317" data-speed="2000">0</h3>
								<span>Total Energy Drinks</span>
							</div>
						</li>
					</ul>
				</div>
		...
		<div class="arlo_tm_contact">
			<div class="container">
				<div class="contact_inner">
					...
					<div class="desc">
						<p class="wow txt" data-splitting>Please fill out the form on this section to contact with me. Or message me on Discord: @0815cracky</p>
					</div>
					<div class="wrapper">
			...
			<div class="container">
				<div class="inner">
					<div class="copy wow fadeInLeft" data-wow-duration="1.5s">
						<p>&copy; myra.nz Copyright 2019-2024. All rights are reserved.</p>
					</div>
					<div class="social wow fadeInLeft" data-wow-duration="1.5s" data-wow-delay=".2s">
						<ul>
							<li><a href="https://www.youtube.com/channel/UCP17Yi-ZNlaGotI2BmG4PTQ"><img class="svg" src="img/svg/social/youtube.svg" alt="" /></a></li>
							<li><a href="https://twitter.com/0815cracky"><img class="svg" src="img/svg/social/twitter.svg" alt="" /></a></li>
							<li><a href="https://discord.gg/A2NgbvQg7s"><img class="svg" src="img/svg/social/discord.svg" alt="" /></a></li>
							<li><a href="https://www.instagram.com/0815cracky/"><img class="svg" src="img/svg/social/instagram.svg" alt="" /></a></li>
							<li><a href="https://www.tiktok.com/@0815cracky"><img class="svg" src="img/svg/social/tik-tok.svg" alt="" /></a></li>
						</ul>
					</div>
				</div>
			</div>
...
window.onload = function() {
  ...
  countUpFromTime("Nov 9, 2004 12:00:00", 'countup1');
};
